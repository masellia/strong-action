...
<style>
/* WP grid spacing + justified text */
.wp-grid .card {
  height: 100%;
}
.wp-grid .card-body {
...
<div class="row wp-grid">
  ...
  <div class="col-md-6 mb-4">
    <div class="card h-100">
      ...
      <div id="wp1" class="collapse show">
        <div class="card-body">
